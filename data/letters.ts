...
export const LETTERS: Letter[] = [
  ...
  {
    id: "l12",
    condition: "To My Dearest Friend, Nandani",
    shortLabel: "you need reminding",
    sealColor: "#ec4899",
    accentColor: "#1a0010",
    content: [
      "Dear Nandani,",
      "Words feel small when I try to describe what you mean to me — but here I am, trying anyway.",
      "You are the kind of person who makes every room feel lighter just by walking in. Your warmth isn't something you put on — it's just who you are, effortlessly and completely.",
      "I think about all the moments we've shared, the conversations that went on for hours, the laughs that came out of nowhere, the times you showed up without being asked — and I feel so incredibly grateful.",
      "You have this rare gift of making people feel like they truly matter. And I want you to know, on this birthday more than ever — you matter. To me, and to everyone lucky enough to know you.",
      "Thank you for being my person, Nandani. Thank you for being you.",
    ],
    closing: "With all the love in this universe 💗",
  },
  {
    id: "l13",
    condition: "The Things I Love About You",
    shortLabel: "you forget your worth",
    sealColor: "#f472b6",
    accentColor: "#1a0510",
    content: [
      "Dear Nandani,",
      "Let me count the ways you make my world better:",
      "🌸 The way you laugh — it's the kind that's impossible to ignore, the kind that makes everything feel okay.",
      "🌸 How you show up for the people you love, quietly and completely, without being asked.",
      "🌸 Your strength. Even when things are hard, you carry yourself with a quiet grace I deeply admire.",
      "🌸 The way you care — not performatively, but genuinely, with your whole heart.",
      "🌸 How you turn ordinary afternoons into memories worth keeping forever.",
      "🌸 The kindness in your eyes when someone needs it most.",
      "You are one of the good ones, Nandani. The really, truly good ones.",
    ],
    closing: "Rooting for you, always 🌸",
  },
  {
    id: "l14",
    condition: "A Birthday Wish Just For You",
    shortLabel: "it's your birthday",
    sealColor: "#f59e0b",
    accentColor: "#1a1200",
    content: [
      "Dear Nandani,",
      "On this beautiful birthday of yours, here is everything I wish for you:",
      "⭐ May you wake up every morning feeling deeply loved — because you are.",
      "⭐ May every dream you've quietly kept to yourself start coming true, one by one.",
      "⭐ May you find joy in the small moments — the chai that's perfectly hot, the song that plays right when you need it.",
      "⭐ May the coming year hold adventures that take your breath away, and people who see exactly how wonderful you are.",
      "⭐ May you be as kind to yourself as you are to everyone around you.",
      "⭐ And may you always know — you are enough. More than enough. Exactly as you are.",
      "Happy Birthday, Nandani. 🎂",
    ],
    closing: "Wishing you the whole universe ⭐",
  },
];
